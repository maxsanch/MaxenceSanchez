const SAE = {
  ...
  "Web": {
    ...
    "projet 2": {
      ...
      "description": "Dans le cadre de la communication 360 d'un festival de musique fictif, nous avons étés amenés à produire un site web présentant ce dernier, il s'agissait pour notre part, à moi et mon groupe de 4 personnes, de créer un festival de rock et de métal sur le thème d'halloween. nosu avons alors du utiliser des couleurs majoritairement sombres dans le thème d'halloween coresspondant à notre charte graphique.",
  ...
  "graphisme": {
    "projet 1": {
      ...
      "description": "Lors d'un nouveau projet de fin de semstre nous avons eu à \"sauver le MISE\", el musée d'impression sur etoffes <br> nous avons alors du choisir un thème, pour ma part, les insectes volants, et créer par la suite des motifs afin de remplacer ceux ayant étés volés au MISE",
      "étapes": "Dans un premier temps j'ai du produire des planches d'inspiration afin de trouver une bonne idée, par la suite, nous avons réalisé les motifs sur illustrator afin de, enfin, les mettre en situation par le billet de différents mockup."
    },
    "projet 2": {
  ...
  "divers": {
    "projet 1": {
      ...
      "description": "Le but de cet exercice était de créer une fake news pour des enfants agés entre 8 et 13 ans, le but était que cette dernière soit crédible pour que, la page suivant, une leçon de fact cheking soit donnée.",
    ...
    "projet 2": {
      ...
      "description": "Nous avons du analyser un site web sur plusieurs aspects, technique, ergonomique, design, sémiologique, contextuel.",
