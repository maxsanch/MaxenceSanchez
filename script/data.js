const SAE = {
  "vidéo": {
    "projet 2": {
      "titre": "Présentation du vélo générateur d'électricité",
      "description": "<p>En tant que second projet officiel en vidéo, j'ai dû réaliser une vidéo présentant le vélo générateur d'électricité réalisé par le lycée Bugatti dans le but de le présenter par la suite, à Sélestat, nous avons alors chacun dû, au sein de notre promotion réaliser cette vidéo afin que l'une d'entre elles soit projetée le jour de la conférence en parlant, à Sélestat.</p><p> J'ai pour ma part réalisé une vidéo présentant chaque aspect du vélo sous forme de question réponse, une manière de traiter le sujet de manière ludique et accessible à tous.</p>",
      "étapes": "<p>Comme beaucoup de projets ou de publicités vidéo, plusieurs étapes ont été nécessaires, dans un premier temps, réaliser un découpage technique en analysant les attendus du client, ici, le lycée Bugatti.</p><p> Par la suite, j'ai dû rédiger notre texte explicatif dans un langage accessible à tous, vulgarisé.</p><p> Enfin les rushs ont étés pris et partagés au sein de la promotion afin que, par la suite, chaque personne ai pu réaliser individuellement ou en binôme le montage de la vidéo.</p>"
    },
    "projet 1": {
      "titre": "Vidéo analyse de films en anglais.",
      "description": "<p>J'ai été amené à réaliser une vidéo en anglais dans le cadre d'un travail de fin de semestre, en l'occurrence ici pour mon premier semestre de cours en IUT dans ma formation BUT MMI.</p><p> Le but était de produire une vidéo pour des personnes cinéphiles analysant un thème ou un auteur-compositeur au choix. </p><p>Pour notre part, nous avons choisi la dystopie dans les films futuristes car ces thèmes nous intéressaient.</p><p> Moi et mon équipe, composée de 4 membres pour ce projet, avons finalement rendu une vidéo mettant en scène les différents univers analysés.</p>",
      "étapes": "<p>Nous avons réspecté plusieurs étapes afin d'assurer un rendu de qualité, dans un premier temps, nous avons dû réaliser un découpage technique, par la suite, nous avons dû réaliser le tournage de la vidéo afin de, par la suite, monter cette dernière.</p>"
    },
  },
  ...
  "web design": {
    "projet 1": {
      ...
      "description": "<p>Pour ce projet j'ai réalisé une maquette Figma de la page Coca-Cola tout en modifiant certains éléments afin de rendre la page un peu plus personnelle.</p><p> Nous avons, tout au long du module avec notre enseignant, designer différents éléments qui ont dû être par la suite utilisé dans cette maquette réalisable sur Figma ou Adobe XD au choix.</p>",
      "étapes": "<p>Pour réaliser ce projet je suis passé par plusieurs étapes, dans un premier temps j'ai dû aller regarder la page du site Coca-Cola France afin de m'en inspirer et de la recréer, j'ai ensuite ajouté des éléments plus personnels tels que les carrousels et la manière de passer d'un élément à un autre, ou encore le haut de la page.</p><p> j'ai dû par ailleur au préalable réaliser la bouteille sur illustrator afin de l'importer sur mon site.</p>"
    },
    "projet 3": {
      "titre": "Passage du mode sombre au claire",
      "description": "Nous avons dû réaliser sur Figma une maquette d'un site trouvé sur dribble afin de, par la suite, le passer en mode claire.",
      "étapes": "Dans un premier temps j'ai alors eu besoin de recréer le site original sur Figma, par la suite, j'ai passé les différents objets en clair en me basant sur des bonnes pratiques."
    },
    "projet 2": {
      "titre": "Maquette pour le site la tanière des loups",
      "description": "<p>Ce projet partait d'une mise en scène en cours dans laquelle un client, ici, notre enseignant nous à donné pour consigne de réaliser la maquette de son site parmi 3 thèmes.</p><p> Nous avons alors choisi celui nous inspirant le plus, la tanière des loups, en compagnie de mon binôme nous avons alors dû interroger le client afin d'analyser ses attendus pour, par la suite, construire la maquette attendue.</p>",
      "étapes": "<p>Afin de créer cette maquette nous avons dû réaliser plusieurs étapes.</p><p> Dans un premier temps nous avons dû préparer des questions à poser au client, partant à l'origine de seulement un simple nom, nous avons alors ensuite éffectué le rendez-vous avec le client afin de comprendre ses attentes, les analyser, et passer enfin à la réalisation de la maquette.</p>"
    },
  ...
  "Web": {
    "projet 3": {
      ...
      "étapes": "<p>Afin de réaliser le site web pour ce projet, j'ai d'abord dû chercher de l'inspiration en me basant sur le jeu original, par la suite, j'ai réalisé mon site d'abord en front end pour les pages principales avant de mettre en place ma base de données afin de, enfin, réaliser le site et lier ma base au PHP.</p>"
    },
    "projet 2": {
      "titre": "Site WordPress pour un festival de musique",
      "description": "<p>Dans le cadre de la communication 360 d'un festival de musique fictif, nous avons été amené à produire un site web présentant ce dernier, il s'agissait pour notre part, à moi et mon groupe de 4 personnes, de créer un festival de rock et de métal sur le thème d'Halloween.</p><p> Nous avons alors dû utiliser des couleurs majoritairement sombres dans le thème d'Halloween correspondant à notre charte graphique.</p>",
    ...
    "projet 1": {
      ...
      "description": "<p>Pour ce projet j'ai réalisé mon premier site portfolio, ce dernier a été réalisé dans le cadre d'un projet scolaire en fin de semestre à gros coefficient, il s'agissait donc d'expliquer chaque compétences développées en détails.</p><p> Ces compétences étaient regroupées sous forme d'ACs ou apprentissages critiques, les renseignements de ce portfolio n'étant pas accordés à ma vision d'un site vitrine, j'ai préféré recréer un site web portfolio regroupant de nouveaux travaux et les mettant en scène.</p><p> Voici <a href='https://maxsanch.github.io/portfolio'><u>le lien</u> </a> de ce dernier<p>",
      "étapes": "<p>Dans un premier temps j'ai dû, pour ce projet, rédiger les textes que je comptais incruster dans ce portfolio, les justifications étant bien plus importantes, ensuite, j'ai réalisé la maquette de ce dernier dans le but d'être plus efficace lors du développement de mon site.</p><p> Enfin après la mise en place de ma banque de données en Javascript, j'ai pu passer au développement de ce dernier.</p>"
    },
  },
  "graphisme": {
    "projet 2": {
    ...
    "projet 1": {
      "titre": "Production de motifs en tous genres",
      "description": "<p>Lors d'un nouveau projet de fin de semestre nous avons eu à \"sauver le MISE\", le musée d'impression sur étoffes <br> nous avons alors dû choisir un thème, pour ma part, les insectes volants, et créer par la suite des motifs afin de remplacer ceux ayant été volé au MISE. </p>",
